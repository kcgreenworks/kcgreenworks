    ...
    <main className="min-h-screen bg-[#f4f1e8] px-6 py-12 text-[#1f2a1f]">
      <article className="mx-auto max-w-4xl space-y-8">
        ...
        <header className="space-y-4">
          ...
          <h1 className="text-4xl font-bold leading-tight md:text-5xl">What Worms Can Eat</h1>
          <p className="text-lg text-[#4b5a4b]">A clear beginner-friendly guide with the practical points you need before starting.</p>
        </header>
        <img src="/lombricultura1en.png" alt="What Worms Can Eat" className="w-full rounded-3xl border border-[#dcd6c8] bg-white object-cover shadow-sm" />
        <section className="space-y-5 rounded-3xl bg-white p-7 shadow-sm">
          <h2 className="text-3xl font-bold">What you need to know</h2>
          <p className="text-lg leading-8 text-[#4b5a4b]">Worms can eat fruit and vegetable scraps, coffee grounds in moderation, crushed eggshells, leaves and soft plant material.</p><p className="text-lg leading-8 text-[#4b5a4b]">Avoid meat, dairy, oils, salty food, spicy food and large amounts of citrus or onion. These create odor and imbalance.</p><p className="text-lg leading-8 text-[#4b5a4b]">Feed less than you think at first. If food remains after several days, reduce the amount and add dry bedding.</p>
        </section>

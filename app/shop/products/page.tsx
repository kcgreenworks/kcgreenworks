...
const products = [
  { title: "LETPOT Smart Hydroponic Garden", description: "Jardín hidropónico inteligente de 12 plantas con luz LED, Wi-Fi y control desde la aplicación.", image: "/images/shop/winner-letpot-hydroponics.jpg", link: "https://www.amazon.com/dp/B0BL3GG6J3" },
  { title: "FCMP Dual-Chamber Composter", description: "Compostera giratoria de doble cámara y 37 galones para producir composta continuamente.", image: "/images/shop/winner-fcmp-composter.jpg", link: "https://www.amazon.com/dp/B009378AG2" },
  { title: "Apera PH20 pH Tester Kit", description: "Medidor de pH impermeable con calibración automática para hidroponía y acuaponía.", image: "/images/shop/winner-apera-ph-meter.jpg", link: "https://www.amazon.com/dp/B01ENFOHN8" },
  { title: "API Freshwater Master Test Kit", description: "Kit completo para medir pH, amoníaco, nitritos y nitratos en sistemas acuapónicos.", image: "/images/shop/winner-api-water-test-kit.jpg", link: "https://www.amazon.com/dp/B000255NCI" },
  { title: "Fiskars Bypass Pruning Shears", description: "Tijeras resistentes y precisas para podar hierbas, vegetales, flores y ramas pequeñas.", image: "/images/shop/winner-fiskars-pruning-shears.jpg", link: "https://www.amazon.com/dp/B00002N66H" },
  { title: "XLUX Soil Moisture Meter", description: "Medidor de humedad de lectura inmediata para evitar el exceso o la falta de riego.", image: "/images/shop/winner-xlux-moisture-meter.jpg", link: "https://www.amazon.com/dp/B014MJ8J2U" },
  { title: "VIVOSUN Seedling Heat Mat", description: "Manta térmica con termostato digital para germinar semillas y fortalecer raíces.", image: "/images/shop/winner-vivosun-heat-mat.jpg", link: "https://www.amazon.com/dp/B016MKY7C8" },
  { title: "Barrina T5 Grow Lights", description: "Juego de ocho luces LED de espectro completo para semilleros y cultivos interiores.", image: "/images/shop/winner-barrina-grow-lights.jpg", link: "https://www.amazon.com/dp/B07V6YJKR6" },
